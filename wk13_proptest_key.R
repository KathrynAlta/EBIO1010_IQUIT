# To learn how to use the test, we will be comparing the proportion of students in the class who voted in this year's election to the 
# national estimate of eligible voters aged 18-29 who voted.

# According to TuftsNow, "almost 50 million young people, defined here as ages 18 to 29, were eligible to vote in the 2024 election; 
# according to the exit poll data, about 42% of them did" 
...
# the data
clasdat <- read.csv("data/1010_SP25_survey.csv")
str(clasdat)
...
# add text to the plot at coordinates 1.9 and .8 that says the X2 value from the summary then (on a new line) the p-value

################ a claim ############
# There is a miniscule probability of the EBIO 1010 voter proportion being greater than the national proportion due to sampling error 
# (chance); we can reject the null hypothesis of no difference between the two proportions.